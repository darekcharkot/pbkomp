...
class HardwaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hardware" do
    assert_difference('Hardware.count') do
      post hardwares_url, params: { hardware: { describe: @hardware.describe, model: @hardware.model, sn: @hardware.sn, type: @hardware.type } }
    end
  ...
  test "should update hardware" do
    patch hardware_url(@hardware), params: { hardware: { describe: @hardware.describe, model: @hardware.model, sn: @hardware.sn, type: @hardware.type } }
